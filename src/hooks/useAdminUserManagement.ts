...
export const ADMIN_PERMISSIONS = {
  ...
  lead_routing: { label: "Lead Routing", description: "View lead routing logs and analytics" },
  ...
  flagged_images: { label: "Flagged Images", description: "Review and resolve flagged images" },

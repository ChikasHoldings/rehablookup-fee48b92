...
export const topCities: CityConfig[] = [
  ...
  { slug: "new-york", city: "New York", population: "8,258,035", state: "New York", stateAbbr: "NY", stateSlug: "new-york", nearbyCities: ["newark", "jersey-city", "yonkers"] },
  { slug: "los-angeles", city: "Los Angeles", population: "3,898,747", state: "California", stateAbbr: "CA", stateSlug: "california", nearbyCities: ["pasadena-ca", "long-beach"] },
  { slug: "chicago", city: "Chicago", population: "2,665,039", state: "Illinois", stateAbbr: "IL", stateSlug: "illinois", nearbyCities: ["aurora-il", "naperville", "joliet"] },
  ...
  { slug: "dallas", city: "Dallas", population: "1,304,379", state: "Texas", stateAbbr: "TX", stateSlug: "texas", nearbyCities: ["fort-worth", "arlington-tx", "plano", "houston"] },
  { slug: "miami", city: "Miami", population: "442,241", state: "Florida", stateAbbr: "FL", stateSlug: "florida", nearbyCities: ["fort-lauderdale", "west-palm-beach", "hollywood-fl"] },
  { slug: "atlanta", city: "Atlanta", population: "498,715", state: "Georgia", stateAbbr: "GA", stateSlug: "georgia", nearbyCities: [] },
  { slug: "denver", city: "Denver", population: "713,252", state: "Colorado", stateAbbr: "CO", stateSlug: "colorado", nearbyCities: ["boulder", "aurora-co", "lakewood-co", "colorado-springs"] },
  { slug: "seattle", city: "Seattle", population: "749,256", state: "Washington", stateAbbr: "WA", stateSlug: "washington", nearbyCities: ["tacoma", "bellevue", "everett"] },
  { slug: "san-diego", city: "San Diego", population: "1,386,932", state: "California", stateAbbr: "CA", stateSlug: "california", nearbyCities: ["los-angeles", "oceanside", "escondido"] },
  { slug: "san-francisco", city: "San Francisco", population: "873,965", state: "California", stateAbbr: "CA", stateSlug: "california", nearbyCities: ["oakland", "san-jose"] },
  { slug: "boston", city: "Boston", population: "675,647", state: "Massachusetts", stateAbbr: "MA", stateSlug: "massachusetts", nearbyCities: ["cambridge", "worcester", "springfield-ma"] },
  { slug: "philadelphia", city: "Philadelphia", population: "1,603,797", state: "Pennsylvania", stateAbbr: "PA", stateSlug: "pennsylvania", nearbyCities: ["pittsburgh", "allentown", "reading"] },
  ...
  { slug: "austin", city: "Austin", population: "978,908", state: "Texas", stateAbbr: "TX", stateSlug: "texas", nearbyCities: ["san-antonio", "round-rock", "houston"] },
  { slug: "jacksonville", city: "Jacksonville", population: "954,614", state: "Florida", stateAbbr: "FL", stateSlug: "florida", nearbyCities: ["orlando", "tampa", "miami"] },
  ...
  { slug: "indianapolis", city: "Indianapolis", population: "887,642", state: "Indiana", stateAbbr: "IN", stateSlug: "indiana", nearbyCities: ["fort-wayne", "evansville", "south-bend"] },
  { slug: "portland", city: "Portland", population: "652,503", state: "Oregon", stateAbbr: "OR", stateSlug: "oregon", nearbyCities: ["eugene", "salem", "gresham"] },
  ...
  { slug: "memphis", city: "Memphis", population: "633,104", state: "Tennessee", stateAbbr: "TN", stateSlug: "tennessee", nearbyCities: ["nashville", "jackson-ms", "chattanooga", "knoxville"] },
  { slug: "louisville", city: "Louisville", population: "633,045", state: "Kentucky", stateAbbr: "KY", stateSlug: "kentucky", nearbyCities: ["lexington", "bowling-green"] },
  // Expansion cities (26-50)
  { slug: "minneapolis", city: "Minneapolis", population: "429,954", state: "Minnesota", stateAbbr: "MN", stateSlug: "minnesota", nearbyCities: ["st-paul", "rochester-mn"] },
  ...
  { slug: "tampa", city: "Tampa", population: "384,959", state: "Florida", stateAbbr: "FL", stateSlug: "florida", nearbyCities: ["orlando", "st-petersburg", "clearwater"] },
  { slug: "salt-lake-city", city: "Salt Lake City", population: "200,133", state: "Utah", stateAbbr: "UT", stateSlug: "utah", nearbyCities: ["ogden"] },
  { slug: "baltimore", city: "Baltimore", population: "585,708", state: "Maryland", stateAbbr: "MD", stateSlug: "maryland", nearbyCities: ["columbia-md", "silver-spring"] },
  { slug: "milwaukee", city: "Milwaukee", population: "577,222", state: "Wisconsin", stateAbbr: "WI", stateSlug: "wisconsin", nearbyCities: ["madison", "green-bay"] },
  { slug: "kansas-city", city: "Kansas City", population: "508,090", state: "Missouri", stateAbbr: "MO", stateSlug: "missouri", nearbyCities: ["st-louis", "springfield-mo", "columbia-mo", "independence"] },
  { slug: "tucson", city: "Tucson", population: "542,629", state: "Arizona", stateAbbr: "AZ", stateSlug: "arizona", nearbyCities: ["phoenix", "scottsdale", "mesa"] },
  { slug: "raleigh", city: "Raleigh", population: "467,665", state: "North Carolina", stateAbbr: "NC", stateSlug: "north-carolina", nearbyCities: ["charlotte", "durham", "greensboro", "wilmington-nc"] },
  { slug: "richmond", city: "Richmond", population: "226,610", state: "Virginia", stateAbbr: "VA", stateSlug: "virginia", nearbyCities: ["virginia-beach", "norfolk", "chesapeake", "arlington-tx"] },
  { slug: "new-orleans", city: "New Orleans", population: "383,997", state: "Louisiana", stateAbbr: "LA", stateSlug: "louisiana", nearbyCities: ["baton-rouge", "shreveport", "lafayette-la"] },
  ...
  { slug: "oklahoma-city", city: "Oklahoma City", population: "681,054", state: "Oklahoma", stateAbbr: "OK", stateSlug: "oklahoma", nearbyCities: ["tulsa", "norman", "broken-arrow"] },
  { slug: "honolulu", city: "Honolulu", population: "350,964", state: "Hawaii", stateAbbr: "HI", stateSlug: "hawaii", nearbyCities: [] },
  { slug: "albuquerque", city: "Albuquerque", population: "564,559", state: "New Mexico", stateAbbr: "NM", stateSlug: "new-mexico", nearbyCities: ["santa-fe", "las-cruces", "rio-rancho"] },
  { slug: "omaha", city: "Omaha", population: "486,051", state: "Nebraska", stateAbbr: "NE", stateSlug: "nebraska", nearbyCities: ["lincoln", "bellevue"] },
  ...
  { slug: "boise", city: "Boise", population: "235,684", state: "Idaho", stateAbbr: "ID", stateSlug: "idaho", nearbyCities: ["nampa", "meridian", "idaho-falls"] },
  { slug: "spokane", city: "Spokane", state: "Washington", stateAbbr: "WA", stateSlug: "washington", nearbyCities: ["seattle", "tacoma", "yakima"] },
  ...
  { slug: "st-louis", city: "St. Louis", state: "Missouri", stateAbbr: "MO", stateSlug: "missouri", nearbyCities: ["kansas-city", "springfield-mo", "columbia-mo"] },
  ...
  { slug: "oxnard", city: "Oxnard", state: "California", stateAbbr: "CA", stateSlug: "california", nearbyCities: ["santa-rosa", "los-angeles", "san-bernardino"] },
  ...
  { slug: "visalia", city: "Visalia", state: "California", stateAbbr: "CA", stateSlug: "california", nearbyCities: ["fresno", "bakersfield", "modesto"] },
  { slug: "pasadena-ca", city: "Pasadena", state: "California", stateAbbr: "CA", stateSlug: "california", nearbyCities: ["los-angeles", "long-beach", "anaheim"] },
  { slug: "joliet", city: "Joliet", state: "Illinois", stateAbbr: "IL", stateSlug: "illinois", nearbyCities: ["chicago", "aurora-il", "naperville", "rockford"] },
  { slug: "rockford", city: "Rockford", state: "Illinois", stateAbbr: "IL", stateSlug: "illinois", nearbyCities: ["chicago", "joliet", "aurora-il", "naperville"] },
  ...
  { slug: "pensacola", city: "Pensacola", state: "Florida", stateAbbr: "FL", stateSlug: "florida", nearbyCities: ["tallahassee", "jacksonville", "mobile"] },
  ...
  { slug: "denton", city: "Denton", state: "Texas", stateAbbr: "TX", stateSlug: "texas", nearbyCities: ["dallas", "fort-worth", "plano", "arlington-tx"] },
  ...
  { slug: "vancouver-wa", city: "Vancouver", state: "Washington", stateAbbr: "WA", stateSlug: "washington", nearbyCities: ["portland", "seattle", "everett"] },
  ...
  { slug: "yakima", city: "Yakima", state: "Washington", stateAbbr: "WA", stateSlug: "washington", nearbyCities: ["seattle", "spokane"] },
  { slug: "roanoke", city: "Roanoke", state: "Virginia", stateAbbr: "VA", stateSlug: "virginia", nearbyCities: ["richmond", "virginia-beach"] },
  { slug: "greenville-sc", city: "Greenville", state: "South Carolina", stateAbbr: "SC", stateSlug: "south-carolina", nearbyCities: ["columbia-sc", "charlotte", "charleston"] },
  ...
  { slug: "myrtle-beach", city: "Myrtle Beach", state: "South Carolina", stateAbbr: "SC", stateSlug: "south-carolina", nearbyCities: ["charleston", "columbia-sc", "wilmington-nc", "greenville-sc"] },
  { slug: "pueblo", city: "Pueblo", state: "Colorado", stateAbbr: "CO", stateSlug: "colorado", nearbyCities: ["colorado-springs", "denver", "aurora-co", "fort-collins"] },
  ...
  { slug: "arvada", city: "Arvada", state: "Colorado", stateAbbr: "CO", stateSlug: "colorado", nearbyCities: ["denver", "lakewood-co", "boulder", "thornton"] },
  { slug: "medford", city: "Medford", state: "Oregon", stateAbbr: "OR", stateSlug: "oregon", nearbyCities: ["portland", "eugene", "salem", "bend"] },
  { slug: "hillsboro", city: "Hillsboro", state: "Oregon", stateAbbr: "OR", stateSlug: "oregon", nearbyCities: ["portland", "salem", "eugene"] },
  { slug: "flint", city: "Flint", state: "Michigan", stateAbbr: "MI", stateSlug: "michigan", nearbyCities: ["detroit", "ann-arbor", "lansing", "grand-rapids"] },
  { slug: "ogden", city: "Ogden", state: "Utah", stateAbbr: "UT", stateSlug: "utah", nearbyCities: ["salt-lake-city"] },
];

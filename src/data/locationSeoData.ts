...
export const statesData: StateData[] = [
  {
    ...
    cities: [
      ...
      { name: "Decatur", slug: "decatur", population: 57938, description: "Decatur provides treatment options in the Tennessee Valley region.", metaDescription: "Find rehab in Decatur, AL. Browse addiction treatment facilities." },
      { name: "Auburn", slug: "auburn", population: 76143, description: "Auburn is home to Auburn University and offers specialized young-adult treatment.", metaDescription: "Drug rehab in Auburn, AL. Find addiction treatment near Auburn University." },
      { name: "Florence", slug: "florence", population: 40184, description: "Florence provides treatment in the Shoals region of northwest Alabama.", metaDescription: "Addiction treatment in Florence, AL. Browse rehab centers in the Shoals." },
      { name: "Gadsden", slug: "gadsden", population: 33685, description: "Gadsden offers treatment options in northeast Alabama along the Coosa River.", metaDescription: "Find rehab in Gadsden, AL. Browse addiction treatment facilities." },
      { name: "Opelika", slug: "opelika", population: 30960, description: "Opelika provides treatment in the Lee County area of east Alabama.", metaDescription: "Drug rehab in Opelika, AL. Find addiction treatment centers." },
    ],
  },
  {
    name: "Alaska",
    ...
    cities: [
      ...
      { name: "Kenai", slug: "kenai", population: 7424, description: "Kenai offers treatment on the Kenai Peninsula south of Anchorage.", metaDescription: "Addiction treatment in Kenai, AK. Find rehab on the Kenai Peninsula." },
      { name: "Kodiak", slug: "kodiak", population: 5968, description: "Kodiak provides recovery services to island and fishing communities.", metaDescription: "Drug rehab in Kodiak, AK. Find addiction treatment services." },
      { name: "Bethel", slug: "bethel", population: 6325, description: "Bethel serves as the treatment hub for western Alaska communities.", metaDescription: "Addiction treatment in Bethel, AK. Browse rehab options in western Alaska." },
      { name: "Homer", slug: "homer", population: 5522, description: "Homer provides treatment services on the southern Kenai Peninsula.", metaDescription: "Find rehab in Homer, AK. Addiction treatment on the Kenai Peninsula." },
    ],
  },
  {
    name: "Arizona",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Bentonville", slug: "bentonville", population: 54164, description: "Bentonville offers treatment in the booming Northwest Arkansas corridor.", metaDescription: "Rehab centers in Bentonville, AR. Find addiction treatment near you." },
      { name: "Pine Bluff", slug: "pine-bluff", population: 41474, description: "Pine Bluff provides accessible treatment in southeast Arkansas.", metaDescription: "Drug rehab in Pine Bluff, AR. Browse verified treatment centers." },
      { name: "Fort Smith", slug: "fort-smith", population: 89142, description: "Fort Smith offers treatment along the Arkansas-Oklahoma border.", metaDescription: "Drug rehab in Fort Smith, AR. Find addiction treatment centers." },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Danbury", slug: "danbury", population: 86518, description: "Danbury offers treatment options in western Connecticut.", metaDescription: "Find rehab in Danbury, CT. Browse addiction treatment facilities." },
      { name: "Meriden", slug: "meriden", population: 60850, description: "Meriden provides accessible treatment in central Connecticut.", metaDescription: "Drug rehab in Meriden, CT. Find verified treatment centers." },
      { name: "Stamford", slug: "stamford", population: 135470, description: "Stamford offers treatment in the affluent Fairfield County corridor.", metaDescription: "Drug rehab in Stamford, CT. Find addiction treatment centers." },
      { name: "Norwalk", slug: "norwalk", population: 91184, description: "Norwalk provides treatment along the Connecticut Gold Coast.", metaDescription: "Addiction treatment in Norwalk, CT. Browse rehab facilities." },
      { name: "Danbury", slug: "danbury", population: 86518, description: "Danbury offers treatment in western Connecticut.", metaDescription: "Find rehab in Danbury, CT. Drug and alcohol treatment programs." },
      { name: "Bristol", slug: "bristol", population: 60833, description: "Bristol provides accessible treatment in central Connecticut.", metaDescription: "Drug rehab in Bristol, CT. Find addiction treatment near you." },
    ],
  },
  {
    name: "Delaware",
    ...
    cities: [
      ...
      { name: "Middletown", slug: "middletown", population: 24042, description: "Middletown offers growing treatment resources in central Delaware.", metaDescription: "Find rehab in Middletown, DE. Browse treatment facilities." },
      { name: "Smyrna", slug: "smyrna", population: 12883, description: "Smyrna provides treatment in the heart of Delaware.", metaDescription: "Drug rehab in Smyrna, DE. Find addiction treatment centers." },
      { name: "Newark", slug: "newark", population: 33698, description: "Newark offers treatment near the University of Delaware campus.", metaDescription: "Drug rehab in Newark, DE. Find addiction treatment centers." },
      { name: "Middletown", slug: "middletown", population: 22350, description: "Middletown provides treatment in central Delaware.", metaDescription: "Addiction treatment in Middletown, DE. Browse rehab facilities." },
      { name: "Smyrna", slug: "smyrna", population: 12340, description: "Smyrna offers recovery services between Dover and Wilmington.", metaDescription: "Find rehab in Smyrna, DE. Drug and alcohol treatment programs." },
      { name: "Milford", slug: "milford", population: 11463, description: "Milford provides treatment in southern Delaware.", metaDescription: "Drug rehab in Milford, DE. Find addiction treatment programs." },
    ],
  },
  {
    name: "Florida",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Augusta", slug: "augusta", population: 202081, description: "Augusta provides treatment with Medical College of Georgia resources.", metaDescription: "Drug rehab in Augusta, GA. Find addiction treatment centers." },
      { name: "Macon", slug: "macon", population: 157346, description: "Macon offers treatment in central Georgia.", metaDescription: "Addiction treatment in Macon, GA. Browse rehab facilities." },
      { name: "Albany", slug: "albany", population: 69647, description: "Albany provides treatment in southwest Georgia.", metaDescription: "Find rehab in Albany, GA. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "Hawaii",
    ...
    cities: [
      ...
      { name: "Hilo", slug: "hilo", population: 45703, description: "Hilo is the Big Island hub for treatment services.", metaDescription: "Drug rehab in Hilo, HI. Find addiction treatment on the Big Island." },
      { name: "Waipahu", slug: "waipahu", population: 41028, description: "Waipahu provides treatment access in western Oahu.", metaDescription: "Addiction treatment in Waipahu, HI. Browse rehab facilities." },
      { name: "Kaneohe", slug: "kaneohe", population: 34597, description: "Kaneohe offers treatment on the windward side of Oahu.", metaDescription: "Find rehab in Kaneohe, HI. Drug and alcohol treatment centers." },
      { name: "Mililani", slug: "mililani", population: 28608, description: "Mililani provides treatment in central Oahu.", metaDescription: "Drug rehab in Mililani, HI. Find addiction treatment services." },
    ],
  },
  {
    name: "Idaho",
    ...
    cities: [
      ...
      { name: "Idaho Falls", slug: "idaho-falls", population: 64908, description: "Idaho Falls offers treatment in eastern Idaho.", metaDescription: "Drug rehab in Idaho Falls, ID. Find addiction treatment centers." },
      { name: "Twin Falls", slug: "twin-falls", population: 51807, description: "Twin Falls provides treatment in the Magic Valley.", metaDescription: "Addiction treatment in Twin Falls, ID. Browse rehab facilities." },
      { name: "Lewiston", slug: "lewiston", population: 33530, description: "Lewiston offers treatment in the Lewis-Clark Valley.", metaDescription: "Find rehab in Lewiston, ID. Drug and alcohol treatment programs." },
      { name: "Caldwell", slug: "caldwell", population: 59338, description: "Caldwell provides treatment near the Boise metro area.", metaDescription: "Drug rehab in Caldwell, ID. Find addiction treatment programs." },
    ],
  },
  {
    name: "Illinois",
    ...
    cities: [
      ...
      { name: "Rockford", slug: "rockford", population: 147651, description: "Rockford provides treatment services in northern Illinois.", metaDescription: "Find rehab in Rockford, IL. Browse addiction treatment centers." },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Cedar Rapids", slug: "cedar-rapids", population: 137193, description: "Cedar Rapids provides treatment in eastern Iowa.", metaDescription: "Drug rehab in Cedar Rapids, IA. Find addiction treatment centers." },
      { name: "Davenport", slug: "davenport", population: 101590, description: "Davenport offers treatment in the Quad Cities region.", metaDescription: "Addiction treatment in Davenport, IA. Browse rehab facilities." },
      { name: "Sioux City", slug: "sioux-city", population: 85797, description: "Sioux City provides treatment in western Iowa near the tri-state area.", metaDescription: "Find rehab in Sioux City, IA. Drug and alcohol treatment programs." },
      { name: "Waterloo", slug: "waterloo", population: 67314, description: "Waterloo offers treatment in the Cedar Valley of northeast Iowa.", metaDescription: "Drug rehab in Waterloo, IA. Find addiction treatment services." },
    ],
  },
  {
    name: "Kansas",
    ...
    cities: [
      ...
      { name: "Topeka", slug: "topeka", population: 126587, description: "Topeka is the state capital with extensive state-funded treatment programs.", metaDescription: "Drug rehab in Topeka, KS. Find addiction treatment in the state capital." },
      { name: "Lawrence", slug: "lawrence", population: 94934, description: "Lawrence offers treatment near the University of Kansas.", metaDescription: "Addiction treatment in Lawrence, KS. Browse rehab facilities." },
      { name: "Salina", slug: "salina", population: 46889, description: "Salina provides treatment in central Kansas.", metaDescription: "Find rehab in Salina, KS. Drug and alcohol treatment programs." },
      { name: "Manhattan", slug: "manhattan", population: 54832, description: "Manhattan offers treatment in the Flint Hills region.", metaDescription: "Drug rehab in Manhattan, KS. Find addiction treatment centers." },
    ],
  },
  {
    name: "Kentucky",
    ...
    cities: [
      ...
      { name: "Louisville", slug: "louisville", population: 633045, description: "Louisville is Kentucky's largest city with extensive treatment networks.", metaDescription: "Drug rehab in Louisville, KY. Find addiction treatment centers." },
      { name: "Bowling Green", slug: "bowling-green", population: 76734, description: "Bowling Green offers treatment in south-central Kentucky.", metaDescription: "Addiction treatment in Bowling Green, KY. Browse rehab facilities." },
      { name: "Owensboro", slug: "owensboro", population: 60183, description: "Owensboro provides treatment in western Kentucky.", metaDescription: "Find rehab in Owensboro, KY. Drug and alcohol treatment programs." },
      { name: "Covington", slug: "covington", population: 40961, description: "Covington offers treatment in the Greater Cincinnati area.", metaDescription: "Drug rehab in Covington, KY. Find addiction treatment services." },
    ],
  },
  {
    name: "Louisiana",
    ...
    cities: [
      ...
      { name: "Shreveport", slug: "shreveport", population: 187593, description: "Shreveport offers treatment in northwest Louisiana.", metaDescription: "Drug rehab in Shreveport, LA. Find addiction treatment centers." },
      { name: "Lake Charles", slug: "lake-charles", population: 83721, description: "Lake Charles provides treatment in southwest Louisiana.", metaDescription: "Addiction treatment in Lake Charles, LA. Browse rehab facilities." },
      { name: "Monroe", slug: "monroe", population: 47702, description: "Monroe offers treatment in northeast Louisiana.", metaDescription: "Find rehab in Monroe, LA. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "Maine",
    ...
    cities: [
      ...
      { name: "Lewiston", slug: "lewiston", population: 37121, description: "Lewiston offers treatment in the Androscoggin Valley.", metaDescription: "Find rehab in Lewiston, ME. Browse addiction treatment." },
      { name: "Brunswick", slug: "brunswick", population: 21756, description: "Brunswick provides treatment resources in midcoast Maine.", metaDescription: "Drug rehab in Brunswick, ME. Find treatment facilities." },
      { name: "Lewiston", slug: "lewiston", population: 37121, description: "Lewiston provides treatment in central Maine.", metaDescription: "Drug rehab in Lewiston, ME. Find addiction treatment centers." },
      { name: "Bangor", slug: "bangor", population: 32029, description: "Bangor offers treatment as northern Maine's largest city.", metaDescription: "Addiction treatment in Bangor, ME. Browse rehab facilities." },
      { name: "Auburn", slug: "auburn", population: 24220, description: "Auburn provides treatment in the Lewiston-Auburn metro area.", metaDescription: "Find rehab in Auburn, ME. Drug and alcohol treatment programs." },
      { name: "Biddeford", slug: "biddeford", population: 22668, description: "Biddeford offers treatment along southern Maine's coast.", metaDescription: "Drug rehab in Biddeford, ME. Find addiction treatment services." },
    ],
  },
  {
    name: "Maryland",
    ...
    cities: [
      ...
      { name: "Frederick", slug: "frederick", population: 78171, description: "Frederick provides treatment in western Maryland.", metaDescription: "Drug rehab in Frederick, MD. Find addiction treatment centers." },
      { name: "Gaithersburg", slug: "gaithersburg", population: 69657, description: "Gaithersburg offers treatment in Montgomery County.", metaDescription: "Addiction treatment in Gaithersburg, MD. Browse rehab facilities." },
      { name: "Bowie", slug: "bowie", population: 58025, description: "Bowie provides treatment in Prince George's County.", metaDescription: "Find rehab in Bowie, MD. Drug and alcohol treatment programs." },
      { name: "Hagerstown", slug: "hagerstown", population: 44091, description: "Hagerstown offers treatment in the Cumberland Valley.", metaDescription: "Drug rehab in Hagerstown, MD. Find addiction treatment services." },
    ],
  },
  {
    name: "Massachusetts",
    ...
    cities: [
      ...
      { name: "Lowell", slug: "lowell", population: 115554, description: "Lowell provides treatment in the Merrimack Valley.", metaDescription: "Drug rehab in Lowell, MA. Find addiction treatment centers." },
      { name: "Brockton", slug: "brockton", population: 105643, description: "Brockton offers treatment south of Boston.", metaDescription: "Addiction treatment in Brockton, MA. Browse rehab facilities." },
      { name: "Fall River", slug: "fall-river", population: 93885, description: "Fall River provides treatment in southeastern Massachusetts.", metaDescription: "Find rehab in Fall River, MA. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "Michigan",
    ...
    cities: [
      ...
      { name: "Lansing", slug: "lansing", population: 112644, description: "Lansing offers treatment as Michigan's capital city.", metaDescription: "Find rehab in Lansing, MI. Browse addiction treatment centers." },
      { name: "Lansing", slug: "lansing", population: 112644, description: "Lansing is the state capital with state-funded treatment programs.", metaDescription: "Drug rehab in Lansing, MI. Find addiction treatment in the state capital." },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Hattiesburg", slug: "hattiesburg", population: 48280, description: "Hattiesburg offers treatment in the Pine Belt region of southern Mississippi.", metaDescription: "Drug rehab in Hattiesburg, MS. Find addiction treatment centers." },
      { name: "Meridian", slug: "meridian", population: 34820, description: "Meridian provides treatment in eastern Mississippi.", metaDescription: "Addiction treatment in Meridian, MS. Browse rehab facilities." },
      { name: "Tupelo", slug: "tupelo", population: 38300, description: "Tupelo offers treatment in northeast Mississippi.", metaDescription: "Find rehab in Tupelo, MS. Drug and alcohol treatment programs." },
      { name: "Olive Branch", slug: "olive-branch", population: 44893, description: "Olive Branch provides treatment near the Memphis metro area.", metaDescription: "Drug rehab in Olive Branch, MS. Find addiction treatment services." },
    ],
  },
  {
    name: "Missouri",
    ...
    cities: [
      ...
      { name: "Independence", slug: "independence", population: 123011, description: "Independence offers treatment in the eastern Kansas City metro.", metaDescription: "Drug rehab in Independence, MO. Find addiction treatment centers." },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Great Falls", slug: "great-falls", population: 60442, description: "Great Falls provides treatment in central Montana.", metaDescription: "Drug rehab in Great Falls, MT. Find addiction treatment centers." },
      { name: "Bozeman", slug: "bozeman", population: 53293, description: "Bozeman offers treatment in the Gallatin Valley.", metaDescription: "Addiction treatment in Bozeman, MT. Browse rehab facilities." },
      { name: "Butte", slug: "butte", population: 34494, description: "Butte provides treatment in southwestern Montana.", metaDescription: "Find rehab in Butte, MT. Drug and alcohol treatment programs." },
      { name: "Kalispell", slug: "kalispell", population: 24558, description: "Kalispell offers treatment near Glacier National Park.", metaDescription: "Drug rehab in Kalispell, MT. Find addiction treatment services." },
    ],
  },
  {
    name: "Nebraska",
    ...
    cities: [
      ...
      { name: "Lincoln", slug: "lincoln", population: 291082, description: "Lincoln is the state capital with comprehensive treatment infrastructure.", metaDescription: "Drug rehab in Lincoln, NE. Find addiction treatment in the state capital." },
      { name: "Grand Island", slug: "grand-island", population: 53131, description: "Grand Island offers treatment in central Nebraska.", metaDescription: "Addiction treatment in Grand Island, NE. Browse rehab facilities." },
      { name: "Kearney", slug: "kearney", population: 33464, description: "Kearney provides treatment in south-central Nebraska.", metaDescription: "Find rehab in Kearney, NE. Drug and alcohol treatment programs." },
      { name: "Norfolk", slug: "norfolk", population: 24610, description: "Norfolk offers treatment in northeast Nebraska.", metaDescription: "Drug rehab in Norfolk, NE. Find addiction treatment services." },
    ],
  },
  {
    name: "Nevada",
    ...
    cities: [
      ...
      { name: "North Las Vegas", slug: "north-las-vegas", population: 262527, description: "North Las Vegas provides treatment in the northern Vegas metro.", metaDescription: "Drug rehab in North Las Vegas, NV. Find addiction treatment centers." },
      { name: "Sparks", slug: "sparks", population: 108445, description: "Sparks offers treatment in the Reno metro area.", metaDescription: "Addiction treatment in Sparks, NV. Browse rehab facilities." },
      { name: "Carson City", slug: "carson-city", population: 58639, description: "Carson City is the state capital with state-funded treatment programs.", metaDescription: "Find rehab in Carson City, NV. Drug and alcohol treatment programs." },
      { name: "Elko", slug: "elko", population: 20279, description: "Elko provides treatment in rural northeastern Nevada.", metaDescription: "Drug rehab in Elko, NV. Find addiction treatment services." },
    ],
  },
  {
    name: "New Hampshire",
    ...
    cities: [
      ...
      { name: "Dover", slug: "dover", population: 32741, description: "Dover provides treatment on the New Hampshire seacoast.", metaDescription: "Find rehab in Dover, NH. Browse addiction treatment facilities." },
      { name: "Keene", slug: "keene", population: 23409, description: "Keene offers treatment in southwestern New Hampshire.", metaDescription: "Drug rehab in Keene, NH. Find verified treatment centers." },
      { name: "Nashua", slug: "nashua", population: 91322, description: "Nashua provides treatment in southern New Hampshire.", metaDescription: "Drug rehab in Nashua, NH. Find addiction treatment centers." },
      { name: "Dover", slug: "dover", population: 32741, description: "Dover offers treatment on the New Hampshire Seacoast.", metaDescription: "Addiction treatment in Dover, NH. Browse rehab facilities." },
      { name: "Rochester", slug: "rochester", population: 31366, description: "Rochester provides treatment in the Lakes Region area.", metaDescription: "Find rehab in Rochester, NH. Drug and alcohol treatment programs." },
      { name: "Keene", slug: "keene", population: 23409, description: "Keene offers treatment in southwest New Hampshire.", metaDescription: "Drug rehab in Keene, NH. Find addiction treatment services." },
    ],
  },
  {
    name: "New Jersey",
    ...
    cities: [
      ...
      { name: "Toms River", slug: "toms-river", population: 95438, description: "Toms River offers treatment on the Jersey Shore.", metaDescription: "Drug rehab in Toms River, NJ. Find addiction treatment centers." },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Las Cruces", slug: "las-cruces", population: 111385, description: "Las Cruces offers treatment in southern New Mexico.", metaDescription: "Drug rehab in Las Cruces, NM. Find addiction treatment centers." },
      { name: "Rio Rancho", slug: "rio-rancho", population: 104046, description: "Rio Rancho provides treatment in the Albuquerque metro area.", metaDescription: "Addiction treatment in Rio Rancho, NM. Browse rehab facilities." },
      { name: "Roswell", slug: "roswell", population: 48422, description: "Roswell offers treatment in southeastern New Mexico.", metaDescription: "Find rehab in Roswell, NM. Drug and alcohol treatment programs." },
      { name: "Farmington", slug: "farmington", population: 45877, description: "Farmington provides treatment in the Four Corners region.", metaDescription: "Drug rehab in Farmington, NM. Find addiction treatment services." },
    ],
  },
  {
    name: "New York",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Grand Forks", slug: "grand-forks", population: 56588, description: "Grand Forks offers treatment in the Red River Valley.", metaDescription: "Find rehab in Grand Forks, ND. Browse treatment facilities." },
      { name: "Mandan", slug: "mandan", population: 22752, description: "Mandan provides treatment near the state capital.", metaDescription: "Drug rehab in Mandan, ND. Find addiction treatment." },
      { name: "Williston", slug: "williston", population: 29160, description: "Williston offers treatment in the Bakken oil region.", metaDescription: "Find rehab in Williston, ND. Browse treatment centers." },
      { name: "Bismarck", slug: "bismarck", population: 73622, description: "Bismarck is the state capital with comprehensive treatment services.", metaDescription: "Drug rehab in Bismarck, ND. Find addiction treatment in the state capital." },
      { name: "Grand Forks", slug: "grand-forks", population: 56588, description: "Grand Forks offers treatment near the University of North Dakota.", metaDescription: "Addiction treatment in Grand Forks, ND. Browse rehab facilities." },
      { name: "Minot", slug: "minot", population: 48639, description: "Minot provides treatment in northwestern North Dakota.", metaDescription: "Find rehab in Minot, ND. Drug and alcohol treatment programs." },
      { name: "West Fargo", slug: "west-fargo", population: 38626, description: "West Fargo offers treatment in the Fargo metro area.", metaDescription: "Drug rehab in West Fargo, ND. Find addiction treatment services." },
    ],
  },
  {
    name: "Ohio",
    ...
    cities: [
      ...
      { name: "Toledo", slug: "toledo", population: 270871, description: "Toledo provides treatment in northwest Ohio.", metaDescription: "Drug rehab in Toledo, OH. Find addiction treatment centers." },
      { name: "Youngstown", slug: "youngstown", population: 60068, description: "Youngstown offers treatment in the Mahoning Valley.", metaDescription: "Addiction treatment in Youngstown, OH. Browse rehab facilities." },
      { name: "Springfield", slug: "springfield", population: 58662, description: "Springfield provides treatment in west-central Ohio.", metaDescription: "Find rehab in Springfield, OH. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "Oklahoma",
    ...
    cities: [
      ...
      { name: "Tulsa", slug: "tulsa", population: 413066, description: "Tulsa offers extensive treatment as Oklahoma's second-largest city.", metaDescription: "Drug rehab in Tulsa, OK. Find addiction treatment centers." },
      { name: "Broken Arrow", slug: "broken-arrow", population: 113540, description: "Broken Arrow provides treatment in the Tulsa metro area.", metaDescription: "Addiction treatment in Broken Arrow, OK. Browse rehab facilities." },
      { name: "Lawton", slug: "lawton", population: 91055, description: "Lawton offers treatment near Fort Sill military base.", metaDescription: "Find rehab in Lawton, OK. Drug and alcohol treatment programs." },
      { name: "Edmond", slug: "edmond", population: 94054, description: "Edmond provides treatment in the northern OKC metro.", metaDescription: "Drug rehab in Edmond, OK. Find addiction treatment services." },
    ],
  },
  {
    name: "Oregon",
    ...
    cities: [
      ...
      { name: "Medford", slug: "medford", population: 85824, description: "Medford provides treatment in southern Oregon's Rogue Valley.", metaDescription: "Find rehab in Medford, OR. Browse addiction treatment centers." },
      { name: "Salem", slug: "salem", population: 175535, description: "Salem is the state capital with state-funded treatment programs.", metaDescription: "Drug rehab in Salem, OR. Find addiction treatment in the state capital." },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Allentown", slug: "allentown", population: 126092, description: "Allentown provides treatment in the Lehigh Valley.", metaDescription: "Drug rehab in Allentown, PA. Find addiction treatment centers." },
      { name: "Erie", slug: "erie", population: 94831, description: "Erie offers treatment along Pennsylvania's Lake Erie shore.", metaDescription: "Addiction treatment in Erie, PA. Browse rehab facilities." },
      { name: "Reading", slug: "reading", population: 95112, description: "Reading provides treatment in Berks County.", metaDescription: "Find rehab in Reading, PA. Drug and alcohol treatment programs." },
      { name: "Scranton", slug: "scranton", population: 76997, description: "Scranton offers treatment in northeastern Pennsylvania.", metaDescription: "Drug rehab in Scranton, PA. Find addiction treatment services." },
    ],
  },
  {
    name: "Rhode Island",
    ...
    cities: [
      ...
      { name: "Cranston", slug: "cranston", population: 82934, description: "Cranston provides treatment in the Providence metro area.", metaDescription: "Drug rehab in Cranston, RI. Find addiction treatment centers." },
      { name: "Pawtucket", slug: "pawtucket", population: 75604, description: "Pawtucket offers treatment in northern Rhode Island.", metaDescription: "Addiction treatment in Pawtucket, RI. Browse rehab facilities." },
      { name: "East Providence", slug: "east-providence", population: 47139, description: "East Providence provides treatment near the capital.", metaDescription: "Find rehab in East Providence, RI. Drug and alcohol treatment programs." },
      { name: "Woonsocket", slug: "woonsocket", population: 44328, description: "Woonsocket offers treatment in the Blackstone Valley.", metaDescription: "Drug rehab in Woonsocket, RI. Find addiction treatment services." },
    ],
  },
  {
    name: "South Carolina",
    ...
    cities: [
      ...
      { name: "Greenville", slug: "greenville", population: 72095, description: "Greenville provides treatment in the Upstate region.", metaDescription: "Drug rehab in Greenville, SC. Find addiction treatment centers." },
      { name: "Mount Pleasant", slug: "mount-pleasant", population: 94992, description: "Mount Pleasant offers treatment near Charleston.", metaDescription: "Addiction treatment in Mount Pleasant, SC. Browse rehab facilities." },
      { name: "Spartanburg", slug: "spartanburg", population: 58681, description: "Spartanburg provides treatment in the Upstate.", metaDescription: "Find rehab in Spartanburg, SC. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "South Dakota",
    ...
    cities: [
      ...
      { name: "Aberdeen", slug: "aberdeen", population: 28495, description: "Aberdeen offers treatment in northeastern South Dakota.", metaDescription: "Find rehab in Aberdeen, SD. Browse treatment centers." },
      { name: "Brookings", slug: "brookings", population: 24587, description: "Brookings provides treatment with university community support.", metaDescription: "Drug rehab in Brookings, SD. Find verified treatment." },
      { name: "Pierre", slug: "pierre", population: 14091, description: "Pierre offers treatment as South Dakota's capital city.", metaDescription: "Rehab in Pierre, SD. Browse addiction treatment facilities." },
      { name: "Rapid City", slug: "rapid-city", population: 77503, description: "Rapid City provides treatment in western South Dakota near the Black Hills.", metaDescription: "Drug rehab in Rapid City, SD. Find addiction treatment centers." },
      { name: "Aberdeen", slug: "aberdeen", population: 28324, description: "Aberdeen offers treatment in northeast South Dakota.", metaDescription: "Addiction treatment in Aberdeen, SD. Browse rehab facilities." },
      { name: "Brookings", slug: "brookings", population: 24687, description: "Brookings provides treatment near South Dakota State University.", metaDescription: "Find rehab in Brookings, SD. Drug and alcohol treatment programs." },
      { name: "Watertown", slug: "watertown", population: 22655, description: "Watertown offers treatment in the northeastern Lake District.", metaDescription: "Drug rehab in Watertown, SD. Find addiction treatment services." },
    ],
  },
  {
    name: "Tennessee",
    ...
    cities: [
      ...
      { name: "Chattanooga", slug: "chattanooga", population: 181099, description: "Chattanooga offers treatment in the scenic Tennessee Valley.", metaDescription: "Find rehab in Chattanooga, TN. Browse addiction treatment centers." },
      { name: "Clarksville", slug: "clarksville", population: 166722, description: "Clarksville provides treatment near Fort Campbell military base.", metaDescription: "Drug rehab in Clarksville, TN. Find treatment facilities." },
      { name: "Chattanooga", slug: "chattanooga", population: 181099, description: "Chattanooga offers treatment in southeast Tennessee.", metaDescription: "Drug rehab in Chattanooga, TN. Find addiction treatment centers." },
      { name: "Clarksville", slug: "clarksville", population: 166722, description: "Clarksville provides treatment near Fort Campbell military base.", metaDescription: "Addiction treatment in Clarksville, TN. Browse rehab facilities." },
      { name: "Murfreesboro", slug: "murfreesboro", population: 152769, description: "Murfreesboro offers treatment in the Nashville metro area.", metaDescription: "Find rehab in Murfreesboro, TN. Drug and alcohol treatment programs." },
      { name: "Jackson", slug: "jackson", population: 68205, description: "Jackson provides treatment in western Tennessee.", metaDescription: "Drug rehab in Jackson, TN. Find addiction treatment services." },
    ],
  },
  {
    name: "Texas",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "West Jordan", slug: "west-jordan", population: 116961, description: "West Jordan offers treatment in the Salt Lake Valley.", metaDescription: "Find rehab in West Jordan, UT. Browse treatment centers." },
      { name: "Orem", slug: "orem", population: 98129, description: "Orem provides treatment in Utah County's Wasatch Front.", metaDescription: "Drug rehab in Orem, UT. Find addiction treatment facilities." },
      { name: "West Valley City", slug: "west-valley-city", population: 140230, description: "West Valley City offers treatment in the Salt Lake metro.", metaDescription: "Drug rehab in West Valley City, UT. Find addiction treatment centers." },
      { name: "Sandy", slug: "sandy", population: 96904, description: "Sandy provides treatment along the Wasatch Front.", metaDescription: "Addiction treatment in Sandy, UT. Browse rehab facilities." },
      { name: "Orem", slug: "orem", population: 97499, description: "Orem offers treatment in Utah County near BYU.", metaDescription: "Find rehab in Orem, UT. Drug and alcohol treatment programs." },
      { name: "Layton", slug: "layton", population: 81472, description: "Layton provides treatment in Davis County.", metaDescription: "Drug rehab in Layton, UT. Find addiction treatment services." },
    ],
  },
  {
    name: "Vermont",
    ...
    cities: [
      ...
      { name: "Rutland", slug: "rutland", population: 15807, description: "Rutland offers treatment in central Vermont.", metaDescription: "Find rehab in Rutland, VT. Browse treatment facilities." },
      { name: "Barre", slug: "barre", population: 8491, description: "Barre provides treatment in Washington County.", metaDescription: "Drug rehab in Barre, VT. Find addiction treatment." },
      { name: "South Burlington", slug: "south-burlington", population: 20293, description: "South Burlington provides treatment in the Burlington metro area.", metaDescription: "Drug rehab in South Burlington, VT. Find addiction treatment centers." },
      { name: "Rutland", slug: "rutland", population: 15807, description: "Rutland offers treatment in central Vermont.", metaDescription: "Addiction treatment in Rutland, VT. Browse rehab facilities." },
      { name: "Barre", slug: "barre", population: 8491, description: "Barre provides treatment in the Washington County area.", metaDescription: "Find rehab in Barre, VT. Drug and alcohol treatment programs." },
      { name: "Montpelier", slug: "montpelier", population: 8074, description: "Montpelier offers treatment as Vermont's capital city.", metaDescription: "Drug rehab in Montpelier, VT. Find addiction treatment services." },
    ],
  },
  {
    name: "Virginia",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Vancouver", slug: "vancouver", population: 190915, description: "Vancouver provides treatment across the river from Portland.", metaDescription: "Drug rehab in Vancouver, WA. Find addiction treatment centers." },
      { name: "Olympia", slug: "olympia", population: 55605, description: "Olympia offers treatment as the state capital.", metaDescription: "Addiction treatment in Olympia, WA. Browse rehab facilities." },
      { name: "Federal Way", slug: "federal-way", population: 99037, description: "Federal Way provides treatment between Seattle and Tacoma.", metaDescription: "Find rehab in Federal Way, WA. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "West Virginia",
    ...
    cities: [
      ...
      { name: "Parkersburg", slug: "parkersburg", population: 29675, description: "Parkersburg offers treatment along the Ohio River.", metaDescription: "Find rehab in Parkersburg, WV. Browse treatment centers." },
      { name: "Wheeling", slug: "wheeling", population: 26711, description: "Wheeling provides treatment in the Northern Panhandle.", metaDescription: "Drug rehab in Wheeling, WV. Find addiction treatment." },
      { name: "Parkersburg", slug: "parkersburg", population: 28712, description: "Parkersburg provides treatment in the Mid-Ohio Valley.", metaDescription: "Drug rehab in Parkersburg, WV. Find addiction treatment centers." },
      { name: "Wheeling", slug: "wheeling", population: 26771, description: "Wheeling offers treatment in the Northern Panhandle.", metaDescription: "Addiction treatment in Wheeling, WV. Browse rehab facilities." },
      { name: "Morgantown", slug: "morgantown", population: 30347, description: "Morgantown provides treatment with WVU medical resources.", metaDescription: "Find rehab in Morgantown, WV. Drug and alcohol treatment programs." },
      { name: "Beckley", slug: "beckley", population: 16646, description: "Beckley offers treatment in southern West Virginia.", metaDescription: "Drug rehab in Beckley, WV. Find addiction treatment services." },
    ],
  },
  {
    name: "Wisconsin",
    ...
    cities: [
      ...
      { name: "Racine", slug: "racine", population: 78199, description: "Racine provides treatment in southeastern Wisconsin.", metaDescription: "Drug rehab in Racine, WI. Find addiction treatment centers." },
      { name: "Waukesha", slug: "waukesha", population: 72489, description: "Waukesha offers treatment in the Milwaukee suburbs.", metaDescription: "Addiction treatment in Waukesha, WI. Browse rehab facilities." },
      { name: "Oshkosh", slug: "oshkosh", population: 66816, description: "Oshkosh provides treatment in the Fox Valley.", metaDescription: "Find rehab in Oshkosh, WI. Drug and alcohol treatment programs." },
    ],
  },
  {
    name: "Wyoming",
    ...
    cities: [
      ...
      { name: "Gillette", slug: "gillette", population: 33403, description: "Gillette offers treatment in energy-rich northeast Wyoming.", metaDescription: "Find rehab in Gillette, WY. Browse treatment centers." },
      { name: "Rock Springs", slug: "rock-springs", population: 23319, description: "Rock Springs provides treatment in southwest Wyoming.", metaDescription: "Drug rehab in Rock Springs, WY. Find treatment facilities." },
      { name: "Sheridan", slug: "sheridan", population: 18186, description: "Sheridan offers treatment at the base of the Bighorn Mountains.", metaDescription: "Rehab in Sheridan, WY. Browse addiction treatment." },
      { name: "Casper", slug: "casper", population: 58720, description: "Casper provides treatment in central Wyoming.", metaDescription: "Drug rehab in Casper, WY. Find addiction treatment centers." },
      { name: "Laramie", slug: "laramie", population: 32711, description: "Laramie offers treatment near the University of Wyoming.", metaDescription: "Addiction treatment in Laramie, WY. Browse rehab facilities." },
      { name: "Gillette", slug: "gillette", population: 33403, description: "Gillette provides treatment in the energy-producing Powder River Basin.", metaDescription: "Find rehab in Gillette, WY. Drug and alcohol treatment programs." },
      { name: "Rock Springs", slug: "rock-springs", population: 23036, description: "Rock Springs offers treatment in southwestern Wyoming.", metaDescription: "Drug rehab in Rock Springs, WY. Find addiction treatment services." },
    ],
  },
];

...
export const providerMarketingChannelConfigs: ProviderMarketingChannelConfig[] = [
  ...
  {
    slug: "rehab-social-media-marketing-strategy",
    label: "Social Media Strategy",
    metaTitle: "Rehab Social Media Strategy | HIPAA-Compliant Marketing",
    ...
    keywords: ["rehab social media strategy", "treatment center social media marketing", "addiction recovery social media", "HIPAA social media", "rehab Facebook marketing"],
  ...
  {
    slug: "rehab-reputation-management-guide",
    label: "Reputation Management Guide",
    metaTitle: "Rehab Reputation Management Guide | Reviews & Online Presence",
    ...
    keywords: ["rehab reputation management guide", "treatment center reviews strategy", "addiction rehab reviews", "online reputation for rehabs", "Google reviews treatment center"],

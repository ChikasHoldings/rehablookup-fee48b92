...
const coreSubstancePages: SubstanceConfig[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How do I tell my doctor I'm addicted to my prescription?", answer: "Being honest with your healthcare provider is a critical first step. Most physicians respond supportively and can help coordinate treatment, adjust medications, or provide referrals. You are protected by medical confidentiality and anti-discrimination laws. If you are uncomfortable speaking with your prescribing doctor, contact an addiction specialist directly, or call the free SAMHSA National Helpline at 1-800-662-4357 for confidential guidance." },

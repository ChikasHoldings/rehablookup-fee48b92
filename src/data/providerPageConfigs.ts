...
export const comparisonPageConfigs: ComparisonPageConfig[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "The Mismatch Problem", content: "Psychology Today's audience skews toward outpatient therapy seekers — people looking for a weekly counselor, not a 30-day inpatient program. If your facility offers IOP or outpatient services, PT can be useful. For residential, detox, or luxury programs, the audience fit is poor." },
...
export const STATE_TREATMENT_COMBOS = [
  { stateSlug: "california", stateName: "California", treatments: ["detox", "residential", "iop", "luxury", "sober-living"] },
  { stateSlug: "florida", stateName: "Florida", treatments: ["detox", "residential", "iop", "luxury", "sober-living"] },
  { stateSlug: "texas", stateName: "Texas", treatments: ["detox", "residential", "iop", "mat", "dual-diagnosis"] },
  { stateSlug: "new-york", stateName: "New York", treatments: ["detox", "residential", "iop", "php", "dual-diagnosis"] },
  { stateSlug: "pennsylvania", stateName: "Pennsylvania", treatments: ["detox", "residential", "iop", "mat", "dual-diagnosis"] },
  { stateSlug: "ohio", stateName: "Ohio", treatments: ["detox", "residential", "mat", "iop", "dual-diagnosis"] },
  { stateSlug: "illinois", stateName: "Illinois", treatments: ["detox", "residential", "iop", "php", "mat"] },
  { stateSlug: "georgia", stateName: "Georgia", treatments: ["detox", "residential", "iop", "sober-living", "dual-diagnosis"] },
];

export const STATE_INSURANCE_COMBOS = [
  { stateSlug: "california", stateName: "California", insurers: ["medicaid", "blue-cross", "aetna"] },
  { stateSlug: "florida", stateName: "Florida", insurers: ["medicaid", "blue-cross", "united-healthcare"] },
  { stateSlug: "texas", stateName: "Texas", insurers: ["medicaid", "blue-cross", "cigna"] },
  { stateSlug: "new-york", stateName: "New York", insurers: ["medicaid", "blue-cross", "aetna"] },
];

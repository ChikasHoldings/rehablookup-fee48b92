            ...
            <div className="p-5 space-y-5 max-h-[60vh] overflow-y-auto">
              ...
              <Card className="bg-muted/20">
                <CardContent className="p-4 space-y-3">
                  ...
                  <DetailRow icon={DollarSign} label="Budget" value={BUDGET_LABELS[selectedMatch.international_placement_cases?.intake_data?.budget_range as string] || "To be discussed"} />

  ...
  const { data: accreditations = [], refetch } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select("id, facility_id, accreditation_type, document_name, document_url, storage_path, expiry_date, issuing_authority, notes, rejection_reason, verification_number, verification_url, verified, verified_at, verified_by, created_at")

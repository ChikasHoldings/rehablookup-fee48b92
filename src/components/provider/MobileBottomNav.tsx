...
export const MobileBottomNav = forwardRef<HTMLDivElement, MobileBottomNavProps>(
  function MobileBottomNav({ onMoreClick }, ref) {
    ...
    return (
      <nav ref={ref} className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-t border-border safe-area-bottom">

...
const QUESTIONS: QuestionCard[] = [
  ...
  },
  {
    ...
    answer:
      "Many verified facilities offer same-day or next-day admission for crisis cases. A five-minute call with our placement team handles insurance and bed availability in parallel.",

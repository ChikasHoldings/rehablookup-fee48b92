...
export const PIPELINE_STAGES: StageConfig[] = [
  ...
  { key: "provider_prequalification", label: "Pre-Qualifying", shortLabel: "Pre-Qual", description: "Verifying facility fit", icon: Shield, color: "border-t-orange-500", badgeColor: "bg-orange-500/10 text-orange-600 border-orange-500/30", nextAction: "Confirm providers", actionOwner: "advisor", tabTarget: "matching" },
  { key: "providers_accepted", label: "Providers Ready", shortLabel: "Ready", description: "Facilities confirmed — present to seeker", icon: CheckCircle, color: "border-t-teal-500", badgeColor: "bg-teal-500/10 text-teal-600 border-teal-500/30", nextAction: "Present to seeker", actionOwner: "advisor", tabTarget: "matching" },
  { key: "presented_to_seeker", label: "Awaiting Decision", shortLabel: "Awaiting", description: "Options sent — awaiting seeker decision", icon: Send, color: "border-t-indigo-500", badgeColor: "bg-indigo-500/10 text-indigo-600 border-indigo-500/30", nextAction: "Follow up with seeker", actionOwner: "seeker", tabTarget: "matching" },

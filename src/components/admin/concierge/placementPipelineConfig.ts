...
export const PIPELINE_STAGES: StageConfig[] = [
  ...
  { key: "seeker_selected", label: "Client Selected", shortLabel: "Selected", description: "Client chose — coordinate admission", icon: Eye, color: "border-t-cyan-500", badgeColor: "bg-cyan-500/10 text-cyan-600 border-cyan-500/30", nextAction: "Begin admission", actionOwner: "advisor", tabTarget: "admission" },

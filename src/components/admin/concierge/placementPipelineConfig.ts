...
export const PIPELINE_STAGES: StageConfig[] = [
  ...
  { key: "intake_reviewed", label: "Reviewed", shortLabel: "Reviewed", description: "Reviewed — assign advisor", icon: Search, color: "border-t-amber-500", badgeColor: "bg-amber-500/10 text-amber-600 border-amber-500/30", nextAction: "Assign advisor", actionOwner: "admin", tabTarget: "manage" },
  { key: "advisor_assigned", label: "Advisor Assigned", shortLabel: "Assigned", description: "Advisor assigned — begin matching", icon: UserCheck, color: "border-t-violet-500", badgeColor: "bg-violet-500/10 text-violet-600 border-violet-500/30", nextAction: "Run matching", actionOwner: "advisor", tabTarget: "providers" },
  { key: "matching_providers", label: "Finding Matches", shortLabel: "Matching", description: "Finding matching facilities", icon: Users, color: "border-t-purple-500", badgeColor: "bg-purple-500/10 text-purple-600 border-purple-500/30", nextAction: "Review matches", actionOwner: "advisor", tabTarget: "providers" },
  { key: "provider_prequalification", label: "Pre-Qualifying", shortLabel: "Pre-Qual", description: "Verifying facility fit", icon: Shield, color: "border-t-orange-500", badgeColor: "bg-orange-500/10 text-orange-600 border-orange-500/30", nextAction: "Send introductions", actionOwner: "advisor", tabTarget: "providers" },
  { key: "providers_accepted", label: "Providers Ready", shortLabel: "Ready", description: "Facilities confirmed — present to seeker", icon: CheckCircle, color: "border-t-teal-500", badgeColor: "bg-teal-500/10 text-teal-600 border-teal-500/30", nextAction: "Present to seeker", actionOwner: "advisor", tabTarget: "providers" },
  { key: "presented_to_seeker", label: "Awaiting Decision", shortLabel: "Awaiting", description: "Options sent — awaiting seeker decision", icon: Send, color: "border-t-indigo-500", badgeColor: "bg-indigo-500/10 text-indigo-600 border-indigo-500/30", nextAction: "Follow up with seeker", actionOwner: "seeker", tabTarget: "providers" },
  ...
  { key: "admitted", label: "Admitted", shortLabel: "Admitted", description: "Admitted — send invoice", icon: Home, color: "border-t-emerald-500", badgeColor: "bg-emerald-500/10 text-emerald-600 border-emerald-500/30", nextAction: "Send invoice", actionOwner: "admin", tabTarget: "admission" },
  { key: "billed", label: "Billed", shortLabel: "Billed", description: "Invoice sent — awaiting payment", icon: DollarSign, color: "border-t-lime-500", badgeColor: "bg-lime-500/10 text-lime-600 border-lime-500/30", nextAction: "Confirm payment", actionOwner: "admin", tabTarget: "admission" },

...
const EVENT_CONFIG: Record<string, { icon: React.ComponentType<any>; label: string; color: string }> = {
  ...
  provider_contacted_seeker: { icon: MessageSquare, label: "Provider Contacted Client", color: "text-teal-500" },
  ...
  seeker_confirmed: { icon: CheckCircle, label: "Client Confirmed", color: "text-green-500" },
  ...
  seeker_notified_options: { icon: Send, label: "Client Notified of Options", color: "text-blue-500" },
  seeker_rejected_facility: { icon: XCircle, label: "Client Rejected Facility", color: "text-red-400" },
  seeker_cancelled: { icon: XCircle, label: "Client Cancelled", color: "text-red-500" },

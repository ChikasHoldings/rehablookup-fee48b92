...
// Sheet (drawer) variant base: every side now scrolls internally when
// content exceeds the drawer height. Top/bottom drawers also gain a
// max-h so they don't cover the entire viewport. The shared
// `overflow-y-auto overscroll-contain` ensures internal scrolling
// works on iOS Safari without leaking gestures to the body.

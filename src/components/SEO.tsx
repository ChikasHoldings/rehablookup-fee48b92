...
import { resolveFacilitySlug, buildFacilityPath } from "@/lib/slugUtils";
...
export function generateSearchResultsSchema(params: {
  ...
  if (params.currentPage && params.totalPages && params.totalPages > 1) {
    ...
    if (prevAbs) searchResultsPage.previousItem = prevAbs;
    if (nextAbs) searchResultsPage.nextItem = nextAbs;
  }

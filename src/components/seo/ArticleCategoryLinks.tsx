...
// Helper to get related article slugs by category for database queries
export const relatedCategorySlugs: Record<string, string[]> = {
  treatment: [
    "types-of-addiction-treatment",
    "what-to-expect-in-rehab",
    "choosing-rehab-center",
  ...
  "location-guides": [
    "los-angeles-drug-rehab-guide",
    "houston-drug-rehab-guide",
    "chicago-drug-rehab-guide",
    "phoenix-drug-rehab-guide",
    "miami-drug-rehab-guide",
    "new-york-drug-rehab-guide",
  ],
  "state-guides": [
    ...
    "texas-rehab-guide",
    "arizona-rehab-guide",
    "colorado-rehab-guide",
  ],
  "city-guides": [
    "boston-drug-rehab-guide",
    "las-vegas-drug-rehab-guide",
    "tampa-drug-rehab-guide",
    "orlando-drug-rehab-guide",
    "detroit-drug-rehab-guide",
    "philadelphia-drug-rehab-guide",
  ],

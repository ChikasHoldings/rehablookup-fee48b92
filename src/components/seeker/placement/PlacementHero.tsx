...
export function PlacementHero({ onGetStarted }: PlacementHeroProps) {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-accent/10 to-transparent rounded-full blur-2xl" />
      ...
      <div className="relative py-8 sm:py-12">
        ...
        <div className="text-center space-y-6 max-w-2xl mx-auto px-4">
          ...
          <motion.div
            ...
            className="pt-4"
          >
            <div className="inline-flex flex-col items-center gap-3 p-6 rounded-2xl bg-card border shadow-lg">
              ...
              <Button 
                ...
                className="w-full mt-2 gap-2 shadow-md hover:shadow-lg transition-shadow"
              >
                Start Your Request

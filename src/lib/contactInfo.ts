 ...
 *
 * Use these constants instead of hardcoding the number again in
 * marketing CTAs / fallback messages — formatting changes (vanity
 * number, area code rotation, dial-code formatting) only need to
 * happen once here.
 *

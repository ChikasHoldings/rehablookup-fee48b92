...
export const ERROR_CODES = {
  ...
  case_create_failed: { code: "case_create_failed", httpStatus: 500, category: "integration", description: "Database insert into international_placement_cases failed.", retryable: true, emittedBy: [] },

...
export const ERROR_CODES = {
  ...
  international_invoice_failed: { code: "international_invoice_failed", httpStatus: 502, category: "integration", description: "Retired 2026-05-20 — was emitted by the international invoice path. No live emitters.", retryable: true, emittedBy: [] },
  case_create_failed: { code: "case_create_failed", httpStatus: 500, category: "integration", description: "Retired 2026-05-20 — was emitted by the international placement case insert. No live emitters.", retryable: true, emittedBy: [] },

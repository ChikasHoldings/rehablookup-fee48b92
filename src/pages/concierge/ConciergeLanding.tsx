                ...
                >
                  {steps.map((step, index) => (
                    <motion.div key={index} variants={fadeInUp}>
                      <Card className="relative bg-card border-0 shadow-sm hover:shadow-md transition-shadow h-full">
              ...
              <div className="max-w-5xl mx-auto">
                ...
                >
                  {benefits.map((benefit, index) => (
                    <motion.div key={index} variants={fadeInUp}>
                      <Card className="border bg-card shadow-sm hover:shadow-md transition-shadow h-full">

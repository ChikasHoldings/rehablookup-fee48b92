...
const EditorialPolicy = () => {
  return (
    <Layout>
      ...
      {/* Hero — POLICY page. Editorial library palette (matches
          Resources). Smaller than State per the brief. */}
      <section className="relative overflow-hidden border-b border-white/5 bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950/55">
        ...
        <div className="container relative z-10 py-6 md:py-8">
          <BreadcrumbNav className="mb-3 [&_*]:!text-white/70 [&_a:hover]:!text-white" items={[{ label: "Editorial Policy" }]} />
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/70">Last updated: April 7, 2026</p>
            </div>
          </div>
        </div>
      </section>

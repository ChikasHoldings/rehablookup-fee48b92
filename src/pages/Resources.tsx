...
export default function Resources() {
  ...
  return (
    <Layout>
      ...
      {/* Hero — EDITORIAL LIBRARY hub. Distinct from the rest of the
          directory network with a reading-room palette (warm slate +
          amber accent), which echoes but is distinct from the SEO
          landing template's editorial treatment. Library photo gives
          the "expert content" feel a premium / curated tone. */}
      <section className="relative overflow-hidden border-b border-white/5">
        <img
          ...
          fetchPriority="high"
        />
        <div className="absolute inset-0 bg-gradient-to-br from-slate-950/90 via-slate-900/85 to-amber-950/60" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(245,158,11,0.12),_transparent_55%)]" />

        <div className="container relative z-10 py-6 md:py-8">
          <BreadcrumbNav items={[{ label: "Resources" }]} className="mb-3 [&_*]:!text-white/70 [&_a:hover]:!text-white" />
          <div className="mx-auto max-w-2xl text-center">
            <div className="mb-2 inline-flex items-center gap-1.5 rounded-full bg-amber-500/15 px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wider text-amber-100 backdrop-blur-sm ring-1 ring-amber-400/25">
              ...
              Editorial · Recovery Library
            </div>
            <h1 className="speakable-headline mb-2 font-display text-2xl font-bold text-white md:text-3xl lg:text-4xl">
              Expert Guides for Recovery
            </h1>
            <p className="speakable-summary text-sm md:text-base text-white/80 max-w-xl mx-auto">
              Vetted articles on addiction treatment, family support, and mental-health recovery.
            </p>
          </div>
        </div>
      </section>

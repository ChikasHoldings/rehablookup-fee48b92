...
const CelebrityRehabUSA = () => {
  ...
  return (
    <Layout>
      ...
      <DirectorySearchCTA title="Search Privately" description="Browse private and executive treatment listings anonymously — searching the directory requires no account." />
    </Layout>
  );
};

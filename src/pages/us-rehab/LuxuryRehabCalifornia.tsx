...
const LuxuryRehabCalifornia = () => {
  ...
  return (
    <Layout>
      ...
      <DirectorySearchCTA title="Find Your California Treatment Center" description="Filter California listings by city, level of care, and insurance, then contact facilities directly." />
    </Layout>
  );
};

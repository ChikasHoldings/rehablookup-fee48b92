...
export const coOccurringPages: CoOccurringConfig[] = [
  ...
  {
    slug: "ocd-and-addiction-treatment",
    title: "OCD & Addiction Treatment",
    conditionName: "Obsessive-Compulsive Disorder",
    metaTitle: "OCD & Addiction Treatment — Integrated Dual Diagnosis Programs | RehabLookup",
    metaDescription: "Find specialized treatment for co-occurring OCD and addiction. Integrated ERP therapy and substance abuse treatment for lasting recovery.",
    heroSubtitle: "Integrated programs combining ERP therapy for OCD with evidence-based addiction treatment.",
    filterKeys: ["dual-diagnosis", "ocd", "mental health", "co-occurring", "obsessive"],
    introContent: "OCD and substance use disorders frequently co-occur — approximately 25% of people with OCD also meet criteria for a substance use disorder. Many individuals with OCD use substances to self-medicate intrusive thoughts, compulsive urges, or the intense anxiety that accompanies the disorder. Effective treatment requires integrated programs that combine Exposure and Response Prevention (ERP) — the gold standard for OCD — with comprehensive addiction treatment. Treating one condition without the other typically leads to relapse in both.",
    sections: [
      { heading: "The OCD-Addiction Connection", content: "OCD creates a cycle of intrusive thoughts (obsessions) and ritualized behaviors (compulsions) that temporarily reduce anxiety. Substances can serve as another form of 'compulsion' — providing temporary relief from the distress of obsessive thoughts. Alcohol, benzodiazepines, and marijuana are most commonly used to self-medicate OCD. Over time, substance use worsens OCD symptoms, creating a dual cycle of dependency." },
      { heading: "Integrated Treatment Approaches", content: "Effective dual diagnosis treatment for OCD and addiction combines ERP (Exposure and Response Prevention) for OCD with CBT and motivational interviewing for addiction. Medication management is critical — SSRIs are first-line for OCD and are non-addictive. Programs must be careful with PRN anxiety medications that could enable cross-addiction. The treatment team should include OCD specialists alongside addiction counselors." },
    ],
    whatToExpect: [
      "Comprehensive OCD and addiction assessment",
      "ERP therapy sessions targeting obsessions/compulsions",
      "SSRI medication management (non-addictive)",
      "CBT addressing both OCD and substance use triggers",
      "Mindfulness-based interventions",
      "Relapse prevention addressing both conditions",
    ],
    benefits: [
      "Treats OCD without addictive medications",
      "ERP reduces compulsive behaviors including substance use",
      "Addresses root anxiety driving both conditions",
      "Higher recovery rates than sequential treatment",
      "Non-addictive medication options (SSRIs)",
      "Breaks dual cycle of OCD and substance dependence",
    ],
    faqs: [
      { question: "Can OCD be treated without benzodiazepines?", answer: "Yes, SSRIs are the first-line medication for OCD and are non-addictive. ERP therapy is highly effective without any medication. For those in recovery, avoiding benzodiazepines is essential. SSRIs like fluvoxamine (Luvox), fluoxetine (Prozac), and sertraline (Zoloft) are FDA-approved for OCD treatment." },
      { question: "How is ERP combined with addiction treatment?", answer: "ERP gradually exposes patients to OCD triggers while preventing compulsive responses — including substance use as a compulsion. This builds distress tolerance skills that apply to both OCD and addiction cravings. Integrated programs schedule ERP sessions alongside group therapy, relapse prevention, and 12-step work." },
      { question: "How long does dual OCD-addiction treatment take?", answer: "Effective dual treatment typically requires 60-90 days of intensive care. ERP alone typically takes 12-20 sessions. Combined with addiction treatment, longer stays allow both conditions to be adequately addressed. Extended aftercare with ongoing ERP maintenance and recovery support is essential." },
    ],
  },
  {
    slug: "bpd-and-addiction-treatment",
    title: "BPD & Addiction Treatment",
    conditionName: "Borderline Personality Disorder",
    metaTitle: "BPD & Addiction Treatment — Specialized Dual Diagnosis Programs | RehabLookup",
    metaDescription: "Find treatment for co-occurring borderline personality disorder and addiction. DBT-based integrated programs for lasting recovery.",
    heroSubtitle: "Specialized DBT-based programs treating borderline personality disorder and substance use simultaneously.",
    filterKeys: ["dual-diagnosis", "borderline", "personality disorder", "mental health", "co-occurring", "dbt"],
    introContent: "Borderline Personality Disorder (BPD) and substance use disorders have one of the highest co-occurrence rates of any psychiatric combination — approximately 50-70% of people with BPD also develop a substance use disorder. The emotional instability, impulsivity, and chronic emptiness characteristic of BPD make individuals highly vulnerable to substance use as a coping mechanism. Dialectical Behavior Therapy (DBT), originally developed for BPD, has become a cornerstone of integrated treatment.",
    sections: [
      { heading: "Why BPD and Addiction Co-Occur", content: "BPD involves intense emotional dysregulation, fear of abandonment, impulsivity, and chronic feelings of emptiness. Substances temporarily numb emotional pain, fill the void of emptiness, reduce social anxiety, and provide relief from self-destructive urges. However, substance use ultimately intensifies BPD symptoms — increasing impulsivity, worsening emotional instability, and damaging the relationships that people with BPD desperately need." },
      { heading: "DBT-Based Integrated Treatment", content: "Dialectical Behavior Therapy (DBT) is the evidence-based gold standard for BPD and adapts well to treat co-occurring addiction. DBT's four skill modules — mindfulness, distress tolerance, emotion regulation, and interpersonal effectiveness — directly address the deficits that drive both BPD symptoms and substance use. Integrated DBT programs add substance-specific interventions including relapse prevention, urge surfing, and harm reduction strategies." },
    ],
    whatToExpect: [
    ...
    benefits: [
      "DBT addresses root emotional dysregulation",
      "Builds concrete coping skills for both conditions",
    ...
    faqs: [
      { question: "What is DBT and how does it help?", answer: "Dialectical Behavior Therapy combines cognitive-behavioral techniques with mindfulness-based practices. It teaches four core skill sets: mindfulness (present-moment awareness), distress tolerance (surviving crises without substances), emotion regulation (managing intense feelings), and interpersonal effectiveness (maintaining relationships). These skills directly address the core deficits in BPD and the triggers for substance use." },
      { question: "How long does BPD-addiction treatment take?", answer: "Comprehensive DBT typically runs 12-18 months for full benefit. Residential treatment for the acute phase is usually 60-90 days, followed by intensive outpatient DBT and step-down support. BPD treatment requires sustained commitment, and ongoing skills practice is important for maintaining gains." },
      { question: "Can BPD be cured?", answer: "While BPD isn't 'cured' in the traditional sense, research shows significant symptom reduction with proper treatment. Many people no longer meet diagnostic criteria after 2-4 years of effective treatment. DBT has the strongest evidence base, with studies showing significant improvements in emotional regulation, relationship functioning, and substance use." },
    ],
  },
  {
    slug: "schizophrenia-and-addiction-treatment",
    title: "Schizophrenia & Addiction Treatment",
    conditionName: "Schizophrenia",
    metaTitle: "Schizophrenia & Addiction Treatment — Integrated Dual Diagnosis | RehabLookup",
    metaDescription: "Find specialized treatment for co-occurring schizophrenia and substance use disorder. Integrated psychiatric and addiction care programs.",
    heroSubtitle: "Integrated psychiatric and addiction treatment for individuals living with schizophrenia and substance use disorders.",
    filterKeys: ["dual-diagnosis", "schizophrenia", "psychosis", "mental health", "co-occurring", "psychiatric"],
    introContent: "Approximately 50% of people with schizophrenia also have a substance use disorder — making it one of the most common and challenging dual diagnosis combinations. Substance use can trigger psychotic episodes, interfere with antipsychotic medications, and dramatically worsen prognosis. Integrated treatment programs that combine psychiatric management with addiction treatment show significantly better outcomes than treating either condition separately.",
    sections: [
      { heading: "Challenges of Co-Occurring Schizophrenia and Addiction", content: "People with schizophrenia use substances for multiple reasons: self-medicating positive symptoms (hallucinations, delusions), alleviating negative symptoms (flat affect, social withdrawal), combating medication side effects, and social acceptance. The most commonly used substances are tobacco, cannabis, alcohol, and cocaine. Substance use worsens psychotic symptoms, reduces medication adherence, and increases hospitalization rates." },
      { heading: "Integrated Treatment Approaches", content: "Effective dual diagnosis programs for schizophrenia and addiction use assertive community treatment (ACT), motivational interviewing adapted for psychosis, social skills training, supported employment, and family psychoeducation. Medication management is critical — atypical antipsychotics with lower side effect profiles improve medication adherence. Programs must accommodate cognitive deficits and adjust therapy accordingly." },
    ],
    whatToExpect: [
      "Comprehensive psychiatric evaluation and stabilization",
      "Antipsychotic medication management and optimization",
      "Motivational interviewing adapted for psychosis",
      "Social skills and cognitive remediation",
      "Substance abuse counseling and relapse prevention",
      "Supported housing and employment assistance",
    ],
    benefits: [
      "Psychiatric stabilization alongside addiction treatment",
      "Medication optimization reduces self-medication need",
      "Addresses cognitive deficits in treatment approach",
      "Reduces hospitalization and crisis episodes",
      "Improves medication adherence",
      "Comprehensive case management and community support",
    ],
    faqs: [
      { question: "Can someone with schizophrenia go to rehab?", answer: "Yes, but they need a program equipped for dual diagnosis with psychiatrists experienced in treating both conditions. Standard addiction programs may not have the psychiatric expertise needed. Look for programs with on-site psychiatric care, experience with psychotic disorders, and the ability to manage antipsychotic medications alongside addiction treatment." },
      { question: "Does substance use cause schizophrenia?", answer: "Substance use doesn't directly cause schizophrenia but can trigger onset in genetically vulnerable individuals and worsen existing symptoms. Cannabis use during adolescence has been associated with increased risk in those with genetic predisposition. Stimulant-induced psychosis can mimic schizophrenia but typically resolves with abstinence." },
      { question: "How long is treatment for dual schizophrenia and addiction?", answer: "Treatment is typically long-term and ongoing. Acute residential stabilization may last 30-90 days, followed by step-down programs and community-based support. Both conditions are chronic and require ongoing management — regular psychiatric care, medication management, peer support, and relapse prevention are essential components of long-term recovery." },
    ],
  },
  {
    slug: "chronic-pain-and-addiction-treatment",
    title: "Chronic Pain & Addiction Treatment",
    conditionName: "Chronic Pain",
    metaTitle: "Chronic Pain & Addiction Treatment — Integrated Pain Management | RehabLookup",
    metaDescription: "Find rehab programs treating chronic pain and opioid addiction together. Non-addictive pain management, MAT, and integrated recovery programs.",
    heroSubtitle: "Integrated programs addressing chronic pain and substance addiction with non-addictive pain management strategies.",
    filterKeys: ["dual-diagnosis", "pain management", "chronic pain", "opioid", "medication-assisted"],
    introContent: "Chronic pain and addiction represent one of the most challenging dual conditions in healthcare. Many opioid addictions begin with legitimate pain management prescriptions. Treatment must address both the pain and the addiction simultaneously — ignoring pain leads to relapse, while continuing opioids perpetuates addiction. Modern integrated programs use multimodal pain management alongside addiction treatment, offering real solutions for both conditions.",
    sections: [
      { heading: "The Pain-Addiction Cycle", content: "Chronic pain and opioid addiction create a vicious cycle: pain leads to opioid use, tolerance develops requiring higher doses, dependence and addiction emerge, and withdrawal includes heightened pain sensitivity (hyperalgesia). This opioid-induced hyperalgesia actually makes pain worse over time, meaning the 'treatment' becomes part of the problem. Breaking this cycle requires addressing both conditions simultaneously." },
      { heading: "Non-Addictive Pain Management", content: "Evidence-based alternatives to opioids for chronic pain include: non-opioid medications (NSAIDs, gabapentin, duloxetine, topical analgesics), physical therapy and rehabilitation, nerve blocks and interventional procedures, CBT for pain management, mindfulness-based pain reduction, acupuncture, exercise programs, and TENS therapy. Many patients find their pain is better managed with multimodal approaches than with opioids alone." },
    ],
    whatToExpect: [
      "Comprehensive pain and addiction assessment",
      "Multimodal non-addictive pain management plan",
      "MAT with buprenorphine (manages both pain and addiction)",
      "Physical therapy and rehabilitation",
      "CBT for pain and addiction management",
      "Gradual opioid taper with pain support",
    ],
    benefits: [
      "Addresses both pain and addiction simultaneously",
      "Non-addictive pain management reduces relapse risk",
      "Buprenorphine treats both opioid addiction and pain",
      "Physical therapy improves function and reduces medication needs",
      "CBT provides long-term pain coping strategies",
      "Breaks the opioid-pain-addiction cycle",
    ],
    faqs: [
      { question: "Can I manage chronic pain without opioids?", answer: "Yes, research increasingly shows that multimodal non-opioid approaches can manage chronic pain as effectively as opioids for many conditions. Options include NSAIDs, gabapentin/pregabalin, duloxetine, physical therapy, nerve blocks, CBT for pain, and complementary approaches. Many patients report better pain management after transitioning away from opioids." },
      { question: "Will I be in pain during rehab?", answer: "Good programs proactively manage pain throughout treatment using non-addictive approaches. Buprenorphine (used in MAT) also has pain-relieving properties. Physical therapy, non-opioid medications, and CBT for pain begin immediately. The goal is never to leave pain untreated — it's to manage it without the substances causing addiction." },
      { question: "Is buprenorphine safe for chronic pain patients?", answer: "Yes, buprenorphine is FDA-approved for both opioid addiction (as Suboxone) and chronic pain (as Belbuca and Butrans). It provides pain relief while having a ceiling effect that reduces overdose risk. For many patients with co-occurring pain and addiction, buprenorphine addresses both conditions with a single medication." },
    ],
  },
];

...
const PRO_BENEFITS = [
  { icon: Percent, title: "20% Off All Unlocks" },
  { icon: Star, title: "Featured Homepage Placement" },
  { icon: TrendingUp, title: "Top of Search Results" },
  { icon: Award, title: "Gold Pro Badge" },
];
        ...
        <Tabs defaultValue={defaultTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="billing" className="gap-2">
              ...
              <span className="hidden sm:inline">Billing & Pro</span>
          ...
          {/* Billing Tab - Cards, Credits Balance, Pro */}
              ...
              <Card className="border-2 border-dashed border-amber-500/30 bg-amber-500/5">
                <CardContent className="p-5">
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex flex-wrap gap-2 mt-1">
                          {PRO_BENEFITS.map((b, i) => (
                            <span key={i} className="text-xs text-muted-foreground flex items-center gap-1">
                              ...
                              {b.title}
                              {i < PRO_BENEFITS.length - 1 && <span className="text-muted-foreground/50 ml-1">•</span>}
                            </span>
                          ))}
                        </div>
                      </div>
                    ...
                    <Button 
                      className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white gap-2 flex-shrink-0"
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">$399/mo</span>
          ...
          <TabsContent value="transactions" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your credit purchases and lead unlocks</CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (

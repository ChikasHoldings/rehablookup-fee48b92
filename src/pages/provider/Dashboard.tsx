  ...
  return (
    <ProviderLayout>
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Status Banner */}
        <Card className="border-l-4" style={{ borderLeftColor: statusConfig.dotClass.replace('bg-', 'var(--') === 'bg-green-500' ? '#22c55e' : statusConfig.dotClass === 'bg-amber-500' ? '#f59e0b' : '#71717a' }}>

              ...
              <CardContent className="p-4 sm:p-5 md:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 md:gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link
                      to="/provider/billing"
                      className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg bg-muted/60 hover:bg-muted transition-colors text-xs font-semibold text-foreground tabular-nums"
                    >
                      <CreditCard className="h-3.5 w-3.5 text-muted-foreground" />
                      {creditsLoading ? "..." : `$${((creditsData?.balance_cents || 0) / 100).toFixed(2)}`}
                    </Link>

                    {/* Plan Badge */}
                    {proStatus.isPro ? (
                      <div className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg bg-gradient-to-r from-amber-500/15 to-amber-600/10 border border-amber-500/25 text-xs font-semibold text-amber-700 dark:text-amber-400">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 hover:border-primary/40 transition-colors text-xs font-semibold text-primary"
                      >

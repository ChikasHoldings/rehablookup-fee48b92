      ...
      <section className="bg-primary py-12 md:py-16">
        <div className="container">
          <nav className="mb-5 flex items-center gap-2 text-sm text-white/70 flex-wrap">
            ...
            <Link to="/treatment-types/residential-inpatient" className="hover:text-white transition-colors">Inpatient</Link>
            <ChevronRight className="h-4 w-4" />
            <Link to={`/treatment-types/residential-inpatient/${stateSlug}`} className="hover:text-white transition-colors">{stateName}</Link>
            <ChevronRight className="h-4 w-4" />
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <Link to="/request-help">
                <Button size="lg" variant="secondary" className="gap-2 w-full sm:w-auto">
                  ...
                  Find Inpatient Rehab in {cityName}
                </Button>
              </Link>

  ...
  const structuredData = [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Detox Programs", "item": "https://rehablookup.com/treatment-types/detox-programs" },
        { "@type": "ListItem", "position": 3, "name": `${stateName}`, "item": `https://rehablookup.com/treatment-types/detox-programs/${stateSlug}` },
        { "@type": "ListItem", "position": 4, "name": `${cityName}`, "item": `https://rehablookup.com/treatment-types/detox-programs/${stateSlug}/${citySlug}` },
      ]
    }
  ];

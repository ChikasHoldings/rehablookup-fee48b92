  ...
  return (
    <Layout>
      ...
      <TreatmentHubHero
        ...
        treatmentName="Outpatient Programs"
        treatmentIcon={Stethoscope}
        breadcrumbLabel="Outpatient Programs"
        subtitle="Flexible addiction treatment that fits your life — PHP, IOP, and standard outpatient programs."
      />
      ...
      <LandingFeaturedSection
        ...
        placement_value="outpatient-programs"
        title="Featured Outpatient Programs"
      />

  ...
  return (
    <Layout>
      ...
      <LandingFeaturedSection
        ...
        placement_value="highmark-rehab"
        title="Featured Centers Accepting Highmark"
      />
      ...
      <InsuranceVerifyCarrierCTA carrier="Highmark" />

      <InsuranceFacilitiesSection insurerSlug="highmark" title="Treatment Centers Accepting Highmark" limit={8} className="border-t border-border" />

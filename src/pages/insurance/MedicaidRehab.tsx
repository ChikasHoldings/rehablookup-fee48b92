  ...
  return (
    <Layout>
      ...
      />      <InsuranceCarrierHero
        ...
        logoSrc="/insurance-logos/medicaid.svg"
        description={"Medicaid covers substance-use treatment in every state."}
      />
      ...
      <LandingFeaturedSection
        ...
        placement_value="medicaid-rehab"
        title="Featured Centers Accepting Medicaid"
      />

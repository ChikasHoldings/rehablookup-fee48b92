  ...
  return (
    <Layout>
      ...
      <LandingFeaturedSection
        ...
        placement_value="ambetter-rehab"
        title="Featured Centers Accepting Ambetter"
      />
      ...
      <InsuranceVerifyCarrierCTA carrier="Ambetter" />

      <InsuranceFacilitiesSection insurerSlug="ambetter" title="Treatment Centers Accepting Ambetter" limit={8} className="border-t border-border" />
      ...
      <StateLinksSection title="Ambetter Rehab Coverage by State" subtitle="Find Ambetter-accepting treatment centers in your state" basePath="/insurance/ambetter-rehab" buttonPrefix="Ambetter in" />

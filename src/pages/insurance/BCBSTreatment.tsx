  ...
  return (
    <Layout>
      ...
      />      <InsuranceCarrierHero
        ...
        logoSrc="/insurance-logos/bcbs.svg"
        description={"BCBS covers addiction treatment across most plans. Find in-network facilities and verify your benefits."}
      />
      ...
      <InsuranceVerifyCarrierCTA carrier="Blue Cross Blue Shield" />

      <InsuranceFacilitiesSection insurerSlug="bcbs" title="Treatment Centers Accepting BCBS" limit={8} className="border-t border-border" />

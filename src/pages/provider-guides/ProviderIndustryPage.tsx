...
import { providerIndustryConfigs } from "@/data/providerGrowthConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderIndustryPage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerIndustryConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      relatedLinks={[
        ...
        { href: "/provider-guides/rehab-admissions-dropping", label: "Fix Declining Admissions" },
        ...providerIndustryConfigs

...
import { providerPatientExperienceConfigs } from "@/data/providerPatientExperienceConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderPatientExperiencePage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerPatientExperienceConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      breadcrumbs={[
        ...
        { label: "Patient Experience", href: "/rehab-marketing" },
        { label: config.label },
      ]}
      ...
      relatedLinks={[
        ...
        ...providerPatientExperienceConfigs

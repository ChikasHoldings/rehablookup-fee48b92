...
import { providerSpecializedMarketConfigs } from "@/data/providerSpecializedMarketConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderSpecializedMarketPage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerSpecializedMarketConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      relatedLinks={[
        ...
        ...providerSpecializedMarketConfigs

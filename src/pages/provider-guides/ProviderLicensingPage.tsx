...
import { providerLicensingConfigs } from "@/data/providerLicensingConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderLicensingPage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerLicensingConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      relatedLinks={[
        ...
        { href: "/provider-guides/carf-vs-joint-commission-rehab-accreditation", label: "CARF vs Joint Commission" },
        ...providerLicensingConfigs

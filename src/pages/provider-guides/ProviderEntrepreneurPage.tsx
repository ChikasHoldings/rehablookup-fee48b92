...
import { providerEntrepreneurConfigs } from "@/data/providerEntrepreneurConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderEntrepreneurPage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerEntrepreneurConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      relatedLinks={[
        ...
        { href: "/provider-guides/how-to-start-outpatient-rehab-center", label: "Start an Outpatient Rehab" },
        ...providerEntrepreneurConfigs

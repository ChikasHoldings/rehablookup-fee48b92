...
import { providerInsuranceOpsConfigs } from "@/data/providerInsuranceOpsConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderInsuranceOpsPage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerInsuranceOpsConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      relatedLinks={[
        ...
        { href: "/provider-guides/rehab-insurance-reimbursement-optimization", label: "Revenue Cycle Guide" },
        ...providerInsuranceOpsConfigs

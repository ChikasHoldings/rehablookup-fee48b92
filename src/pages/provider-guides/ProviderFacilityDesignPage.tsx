...
import { providerFacilityDesignConfigs } from "@/data/providerFacilityDesignConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderFacilityDesignPage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerFacilityDesignConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      breadcrumbs={[
        ...
        { label: "Facility Design", href: "/rehab-marketing" },
        { label: config.label },
      ]}

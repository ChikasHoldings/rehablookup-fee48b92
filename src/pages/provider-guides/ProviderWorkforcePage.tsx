...
import { providerWorkforceConfigs } from "@/data/providerWorkforceConfigs";
import NotFound from "@/pages/NotFound";

export default function ProviderWorkforcePage() {
  const { pathname } = useLocation();
  const slug = pathname.replace("/provider-guides/", "");
  const config = providerWorkforceConfigs.find(c => c.slug === slug);
  ...
  return (
    <ProviderConversionPage
      ...
      relatedLinks={[
        ...
        { href: "/provider-guides/rehab-staff-recruitment-strategies", label: "Staff Recruitment Guide" },
        ...providerWorkforceConfigs

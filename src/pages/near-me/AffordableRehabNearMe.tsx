  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Find affordable rehabilitation centers near you${stateData ? ` in ${stateData.state}` : ""}. Compare ${facilities.length > 0 ? facilities.length + "+" : ""} treatment facilities. Free insurance verification.`}
      ...
      <LandingFeaturedSection
        ...
        title={stateData ? `Featured Affordable Rehab Centers in ${stateData.state}` : `Featured Affordable Rehab Centers Near You`}
      />

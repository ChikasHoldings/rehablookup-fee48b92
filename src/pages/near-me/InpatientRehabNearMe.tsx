  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Find inpatient rehab centers near you${stateData ? ` in ${stateData.state}` : ""}. Compare ${facilities.length > 0 ? facilities.length + "+" : ""} residential treatment facilities offering 24/7 care, medical detox, and evidence-based therapy.`}
      ...
      <LandingFeaturedSection
        ...
        title={stateData ? `Featured Inpatient Rehab Centers in ${stateData.state}` : `Featured Inpatient Rehab Centers Near You`}
      />
      ...
      <section className="py-12 bg-background">
        <div className="container">
          ...
          <p className="text-muted-foreground mb-8">
            Browse {facilities.length > 0 ? `${facilities.length > 0 ? facilities.length + "+" : ""}` : ""} residential facilities offering intensive 24/7 addiction treatment.
          </p>

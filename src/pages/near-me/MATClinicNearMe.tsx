  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Find medication-assisted treatment (MAT) clinics near you${stateData ? ` in ${stateData.state}` : ""}. Compare ${facilities.length}+ verified treatment facilities. Free insurance verification.`}

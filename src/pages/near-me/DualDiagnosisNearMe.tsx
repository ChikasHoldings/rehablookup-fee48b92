  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Find dual diagnosis treatment centers near you${stateData ? ` in ${stateData.state}` : ""}. Integrated care for addiction and mental health disorders at ${facilities.length > 0 ? facilities.length + "+" : ""} facilities.`}
      ...
      <LandingFeaturedSection
        ...
        title={stateData ? `Featured Dual Diagnosis Centers in ${stateData.state}` : `Featured Dual Diagnosis Centers Near You`}
      />
      ...
      <section className="py-12 bg-background">
        <div className="container">
          ...
          <p className="text-muted-foreground mb-8">
            Browse {facilities.length > 0 ? `${facilities.length > 0 ? facilities.length + "+" : ""}` : ""} facilities offering integrated mental health and addiction treatment.
          </p>

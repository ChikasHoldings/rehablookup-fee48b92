      ...
      <section className="py-6 bg-muted/30 border-b">
        <div className="container">
          <p className="text-center text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            {stateData 
              ? `Looking for medical detox in ${stateData.state}? Browse ${facilities.length > 0 ? facilities.length + "+" : ""} detoxification centers offering medically-supervised withdrawal management. Most facilities accept major insurance including Aetna, BCBS, Cigna, and United Healthcare.${
      ...
      <section className="py-12 bg-background">
        <div className="container">
          ...
          <p className="text-muted-foreground mb-8">
            {facilities.length > 0
              ? `Browse ${facilities.length > 0 ? facilities.length + "+" : ""} medically-supervised detox facilities.`

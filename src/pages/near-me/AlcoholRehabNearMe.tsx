  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Find alcohol rehabilitation centers near you${stateData ? ` in ${stateData.state}` : ""}. Compare ${facilities.length > 0 ? facilities.length + "+" : ""} treatment facilities offering detox, inpatient, and outpatient alcohol treatment programs.`}
      ...
      <LandingFeaturedSection
        ...
        title={stateData ? `Featured Alcohol Rehab Centers in ${stateData.state}` : `Featured Alcohol Rehab Centers Near You`}
      />
      ...
      <section className="py-6 bg-muted/30 border-b">
        <div className="container">
          <p className="text-center text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            {stateData 
              ? `Searching for alcohol rehab in ${stateData.state}? Our directory features ${facilities.length > 0 ? facilities.length + "+" : ""} treatment centers offering detox, inpatient, and outpatient programs. Many facilities accept major insurance including Aetna, BCBS, Cigna, and United Healthcare.${
      ...
      <section className="py-12 bg-background">
        <div className="container">
          ...
          <p className="text-muted-foreground mb-8">
            Browse {facilities.length > 0 ? `${facilities.length > 0 ? facilities.length + "+" : ""}` : ""} facilities offering alcohol addiction treatment.
          </p>

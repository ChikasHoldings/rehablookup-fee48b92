...
const pages = [
  ...
  { path: "/drug-rehab-centers", title: "Drug Rehab Centers", desc: "Find drug rehab center listings offering detox, inpatient, and outpatient programs. Compare facilities and start recovery.", bc: [{ name: "Home", url: "/" }, { name: "Treatment Types", url: "/treatment-types" }, { name: "Drug Rehab Centers", url: "/drug-rehab-centers" }] },

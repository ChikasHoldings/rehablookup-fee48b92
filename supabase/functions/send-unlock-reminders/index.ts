  ...
  try {
    ...
    const stages: ReminderStage[] = [
      ...
      },
      {
        ...
        highIntentOnly: false,
        sendSms: false,
        subject: (fn) => `⏳ Lead still available — don't miss out — ${fn}`,
        getEmail: getStillAvailableEmail,
        inAppTitle: "⏳ Lead Still Available",
        inAppMessage: (lp) => `${lp.maskedName} is still waiting after ${Math.round(lp.hoursAgo)}h. This lead may be shared with others soon.`,
        notificationType: "reminder",
      },
      {
        name: "20h",
        ...
        prevColumn: "reminder_12h_sent_at",
        highIntentOnly: false,
